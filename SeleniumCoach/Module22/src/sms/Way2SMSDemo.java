...
public class Way2SMSDemo {
	...
	public void sendSMS() throws Exception{
		...
		String smsText= driver.findElement(By.xpath("//*[@id='greet1']")).getText();
		
		driver.findElement(By.id("mobile")).sendKeys("8309386750");
		driver.findElement(By.id("message")).sendKeys(smsText);
